...
exports.lambda = new client_lambda_1.Lambda({
  region: process.env.region,
});
exports.default = function (service, functionName, eventObj, invocationType) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          event = __assign(__assign({}, defaults), eventObj);
          invokeParams = {
            FunctionName: ''
              .concat(process.env.cfstack, '-')
              .concat(service, '-')
              .concat(process.env.stage, '-')
              .concat(functionName),
            InvocationType: type,
            Payload: Buffer.from(JSON.stringify(event), 'utf8'),
          };
          return [4 /*yield*/, exports.lambda.invoke(invokeParams)];
        case 1:
          data = _a.sent();
          payloadResponse = data.Payload
            ? Buffer.from(data.Payload).toString()
            : '{}';
          parsedData = payloadResponse ? JSON.parse(payloadResponse) : {};
